...
- Async and await refactor of data access: Refactor callback style MySQL models to Promise based APIs using async/await or a modern ORM to simplify asynchronous control flow, improve error propagation, and make the codebase easier to maintain and test.
