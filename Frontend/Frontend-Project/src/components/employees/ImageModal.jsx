...
function ImageModal({ isOpen, imageSrc, employee, onClose }) {
      ...
      <div className="bg-gray-900 rounded-lg max-w-[95vw] max-h-[95vh] w-full h-full relative flex flex-col">
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-700 bg-gray-800">
          <div className="flex-1">
            <h2 className="text-xl font-bold text-white">ID Card - {employee.username}</h2>
        ...
        >
          <div className="w-full h-full flex items-center justify-center overflow-hidden">
            <img
              ref={imageRef}
              src={imageSrc}
              alt={`ID Card of ${employee.username}`}
        ...
        <div className="p-3 border-t border-gray-700 bg-gray-800">
          <div className="grid grid-cols-4 gap-4 text-xs">
            ...
            <div>
              ...
              <p className="text-white">Level {employee.user_type}</p>
            </div>
          </div>
        </div>
      </div>
