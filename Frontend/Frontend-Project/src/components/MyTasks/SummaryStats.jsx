...
const SummaryStats = ({ counts }) => {
  return (
    <div className="mt-8 p-6 bg-gray-800/30 rounded-2xl border border-gray-700/50">
      <h4 className="font-semibold text-white mb-4">Active Tasks Summary</h4>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="text-center p-4 bg-gray-800/50 rounded-xl border border-gray-700/30">
          ...
          <div className="text-gray-400 text-sm">Total Active Tasks</div>
        </div>
        ...
        <div className="text-center p-4 bg-purple-500/10 rounded-xl border border-purple-500/20">
          <div className="text-2xl font-bold text-purple-300">{counts.ready_for_review}</div>
          <div className="text-purple-400/80 text-sm">Ready for Review</div>
        </div>
      </div>
    </div>
  );
